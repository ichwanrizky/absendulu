...
const ModalEdit = (props: Props) => {
  ...
  const [lokasi, setLokasi] = useState(data.lokasi);
    ...
    if (confirm("Edit this data?")) {
      ...
      try {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_API_URL}/api/web/lokasitambahan/${data.id}?menu_url=${menu_url}`,
          {
            method: "POST",
            headers: {
              ...
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <div className="form-group mb-3">
                    <label className="mb-1 fw-semibold small">LOCATION</label>
                    <input
                      type="text"
