...
const ModalEdit = (props: Props) => {
  ...
  const [menuGroup, setMenuGroup] = useState(dataEdit.menu_group_id.toString());
  const [menu, setMenu] = useState(dataEdit.menu);
  const [urut, setUrut] = useState(dataEdit.urut.toString());
