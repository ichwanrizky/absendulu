...
import ApprovalIzinData from "./data";

const getDataIzin = async (uuid: string, token: string) => {
  try {
    const response = await fetch(
      process.env.NEXT_PUBLIC_API_URL + "/api/web/getapprovalizin/" + uuid,
      {
        method: "GET",
        headers: {
...
const ApprovalIzinPegawai = async ({ params }: any) => {
...
export default ApprovalIzinPegawai;
